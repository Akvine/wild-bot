...
public class ApiExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handleBadCredentialsException(BadCredentialsException exception) {
        ErrorResponse errorResponse =
                new ErrorResponse(BAD_CREDENTIALS_ERROR, exception.getMessage(), exception.getMessage());
        return new ResponseEntity<>(errorResponse, new HttpHeaders(), HttpStatus.BAD_REQUEST);
    }
    ...
    public ResponseEntity<ErrorResponse> handleValidationException(ValidationException exception) {
        ErrorResponse errorResponse =
                new ErrorResponse(exception.getErrorCode(), exception.getMessage(), exception.getMessage());
        return new ResponseEntity<>(errorResponse, new HttpHeaders(), HttpStatus.BAD_REQUEST);
    }

    @ExceptionHandler(AdvertAlreadyInPauseStateException.class)
    public ResponseEntity<ErrorResponse> handleAdvertAlreadyInPauseStateException(
            AdvertAlreadyInPauseStateException exception) {
        ErrorResponse errorResponse = new ErrorResponse(
                ApiErrorConstants.ADVERT_ALREADY_IN_PAUSE_STATE_ERROR, exception.getMessage(), exception.getMessage());
        return new ResponseEntity<>(errorResponse, new HttpHeaders(), HttpStatus.BAD_REQUEST);
    }
    ...
    public ResponseEntity<ErrorResponse> handleClientNotFoundException(ClientNotFoundException exception) {
        ErrorResponse errorResponse = new ErrorResponse(
                ApiErrorConstants.CLIENT_NOT_FOUND_ERROR, exception.getMessage(), exception.getMessage());
        return new ResponseEntity<>(errorResponse, new HttpHeaders(), HttpStatus.BAD_REQUEST);
    }
    ...
    protected ResponseEntity<Object> handleNoResourceFoundException(
        ...
        ErrorResponse errorResponse = new ErrorResponse(ApiErrorConstants.RESOURCE_NOT_FOUND_ERROR, message, message);
        return new ResponseEntity<>(errorResponse, new HttpHeaders(), HttpStatus.BAD_REQUEST);
    }
    ...
    protected ResponseEntity<Object> handleMethodArgumentNotValid(
        ...
        ErrorResponse errorResponse =
                new ErrorResponse(ApiErrorConstants.Validation.FIELD_NOT_PRESENTED_ERROR, errorMessage, errorMessage);
        return new ResponseEntity<>(errorResponse, new HttpHeaders(), HttpStatus.BAD_REQUEST);
    }
    ...
    protected ResponseEntity<Object> handleHttpMessageNotReadable(
        ...
        ErrorResponse errorResponse =
                new ErrorResponse(ApiErrorConstants.JSON_BODY_INVALID_ERROR, errorMessage, errorMessage);
        return new ResponseEntity<>(errorResponse, new HttpHeaders(), HttpStatus.BAD_REQUEST);
    }
    ...
    public ResponseEntity<ErrorResponse> handleOtpInvalidAttemptException(OtpInvalidAttemptException exception) {
        logger.info(
                "Login=[{}] entered wrong otp! Attempts left=[{}], exceptionMessage=[{}]",
                exception.getLogin(),
    ...
    public ResponseEntity<ErrorResponse> handleNoSessionException(NoSessionException exception) {
        ...
        ErrorResponse errorResponse = new ErrorResponse(ApiErrorConstants.NO_SESSION_ERROR, exception.getMessage());
        return new ResponseEntity<>(errorResponse, new HttpHeaders(), HttpStatus.BAD_REQUEST);
    }
    ...
    public ResponseEntity<ErrorResponse> handleWrongSessionException(WrongSessionException exception) {
        ...
        ErrorResponse errorResponse =
                new ErrorResponse(ApiErrorConstants.Security.INVALID_SESSION_ERROR, exception.getMessage());
        return new ResponseEntity<>(errorResponse, new HttpHeaders(), HttpStatus.BAD_REQUEST);
    }

    @ExceptionHandler(RegistrationNotStartedException.class)
    public ResponseEntity<ErrorResponse> handleRegistrationNotStartedException(
            RegistrationNotStartedException exception) {
        logger.info("Registration not started yet", exception);
        ErrorResponse errorResponse =
                new ErrorResponse(ApiErrorConstants.Security.ACTION_NOT_STARTED_ERROR, exception.getMessage());
        return new ResponseEntity<>(errorResponse, new HttpHeaders(), HttpStatus.BAD_REQUEST);
    }

    @ExceptionHandler(RegistrationWrongStateException.class)
    public ResponseEntity<ErrorResponse> handleRegistrationWrongStateException(
            RegistrationWrongStateException exception) {
        logger.warn("Registration in wrong state", exception);
        ErrorResponse errorResponse =
                new ErrorResponse(ApiErrorConstants.Security.INVALID_STATE_ERROR, exception.getMessage());
        return new ResponseEntity<>(errorResponse, new HttpHeaders(), HttpStatus.BAD_REQUEST);
    }
    ...
    public ResponseEntity<ErrorResponse> handleOtpExpiredException(OtpExpiredException exception) {
        logger.info(
                "One-time-password is expired, another one should be generated: message={}, otpCountLeft={}",
                exception.getMessage(),
                exception.getOtpCountLeft());
        ErrorResponse errorResponse = new ErrorResponse(
                ApiErrorConstants.Security.OTP_EXPIRED_ERROR,
                "One time password is expired! You need to receive another one! OtpCountLeft="
                        + exception.getOtpCountLeft());
        return new ResponseEntity<>(errorResponse, new HttpHeaders(), HttpStatus.BAD_REQUEST);
    }

    @ExceptionHandler(NoMoreNewOtpAvailableException.class)
    public ResponseEntity<ErrorResponse> handleNoMoreNewOtpAvailableException(
            NoMoreNewOtpAvailableException exception, HttpServletRequest request) {
        logger.info(
                "No more new one-time-password can be generated: userWasBlocked={}, exceptionMessage={} ",
                exception.userWasBlocked(),
                exception.getMessage());
        if (exception.userWasBlocked()) {
            securityHelper.doLogout(request);
        }
        ErrorResponse errorResponse =
                new ErrorResponse(ApiErrorConstants.Security.LIMIT_REACHED_ERROR, exception.getMessage());
        return new ResponseEntity<>(errorResponse, new HttpHeaders(), HttpStatus.BAD_REQUEST);
    }
    ...
    public ResponseEntity<ErrorResponse> handleActionNotStartedException(ActionNotStartedException ex) {
        ...
        ErrorResponse errorResponse =
                new ErrorResponse(ApiErrorConstants.Security.ACTION_NOT_STARTED_ERROR, ex.getMessage());
        return new ResponseEntity<>(errorResponse, new HttpHeaders(), HttpStatus.BAD_REQUEST);
    }
    ...
    public ResponseEntity<ErrorResponse> handleBadCredentials(
        ...
        ErrorResponse errorResponse =
                new ErrorResponse(ApiErrorConstants.Security.BAD_CREDENTIALS_ERROR, exception.getMessage());
        return new ResponseEntity<>(errorResponse, new HttpHeaders(), HttpStatus.BAD_REQUEST);
    }
}
