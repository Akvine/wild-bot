...
public class LockConfig {
    ...
    public SLockProvider lockProvider(
            DataSource dataSource, KeepAliveService keepAliveService, PlatformTransactionManager transactionManager) {
        return new DatabaseSLockProvider(
                dataSource,
                transactionManager,
                keepAliveService,
                dbLockCheckIntervalMillis,
                dbLockExpireAfterCreatedSeconds,
                dbLockMaxWaitingThreadsPerLock);
    }
