    ...
    public void validate(String status) {
        if (StringUtils.isBlank(status)) {
            throw new ValidationException(
                    ApiErrorConstants.Validation.ADVERT_STATUS_BLANK_ERROR, "Advert status is blank");
        }
        ...
        try {
            ...
            throw new ValidationException(
                    ApiErrorConstants.Validation.ADVERT_STATUS_INVALID_ERROR, "Advert status is invalid");
        }
    }
}
